...
class CreateProfile extends React.Component {
  ...
  handleChange(event) {
    ...
    switch(event.target.id) {
      case 'city':
        this.setState({ valueCity: value });
        break;
      case 'state':
        this.setState({ valueState: value });
        break;
      case 'genre':
        this.setState({ valueGenre: value });
        break;
      case 'date':
        this.setState({ valueBirthdate: value });
        break;
      case 'img':
        this.setState({ valueImageUrl: value });
        break;
      case 'bio':
        this.setState({ valueBio: value });
        break;
      case 'bandcamp':
        this.setState({ valueBandcampUrl: value });
        break;
      case 'spotify':
        this.setState({ valueSpotifyUrl: value });
        break;
      case 'facebook':
        this.setState({ valueFacebookUrl: value });
        break;
      case 'homepage':
        this.setState({ valueHomepageUrl: value });
        break;
      case 'phone':
        this.setState({ valuePhoneNum: value });
        break;
    }
  }
