...
Musician.belongsTo(Account); // adds a account_id row to hold the account reference. 
                            ...
                            // .hasOne method does the same thing as the belongsTo method except Musician and Account reverse rolls.
...
Listing.init({
  ...
  description: Sequelize.STRING(1500), // will probably need to extend the length.
...
Profile.belongsTo(Musician);
Profile.belongsTo(Band);
Musician.hasOne(Profile);
Band.hasOne(Profile);
